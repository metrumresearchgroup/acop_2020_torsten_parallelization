...
\begin{multicols}{2}
\footnotesize{\url{https://github.com/metrumresearchgroup/acop_2020_torsten_parallelization}}
\begin{flushright}
\includegraphics[width=0.2\linewidth]{./figure/github_repo_qr_code.png}
\end{flushright}
\end{multicols}  
}
